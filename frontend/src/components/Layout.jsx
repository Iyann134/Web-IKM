        ...
        <div className="mx-auto flex max-w-[1440px] items-center justify-between px-6 py-4 md:px-12 h-24">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <NavLink
              to="/"
              className={({ isActive }) =>
                `py-1.5 text-[18px] font-semibold tracking-wide font-['Poppins'] transition-colors ${isActive ? 'text-[#8b0000] border-b-2 border-[#8b0000]' : 'text-black/85 hover:text-[#8b0000]'
                }`
              }
            >
              Beranda
            ...
            <div className="relative group">
              <button
                type="button"
                className={`flex items-center gap-1.5 py-1.5 text-[18px] font-semibold tracking-wide font-['Poppins'] transition-colors cursor-pointer ${location.pathname.startsWith('/tentang') ? 'text-[#8b0000] border-b-2 border-[#8b0000]' : 'text-black/85 hover:text-[#8b0000]'
                  }`}
              >
                <span>Tentang</span>
              ...
              <div className="absolute left-0 top-full mt-1 w-52 origin-top-left rounded-xl border border-slate-200/80 bg-white p-2 shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform scale-95 group-hover:scale-100 z-50">
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center gap-3 rounded-lg px-4 py-2.5 text-[16px] font-semibold transition ${isActive && location.pathname === '/tentang/latar-belakang'
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center gap-3 rounded-lg px-4 py-2.5 text-[16px] font-semibold transition ${isActive && location.pathname === '/tentang/visi-misi'
                      ? 'bg-[#8b0000]/10 text-[#8b0000]'
                      : 'text-slate-700 hover:bg-slate-50 hover:text-[#8b0000]'
                    }`
                  }
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center gap-3 rounded-lg px-4 py-2.5 text-[16px] font-semibold transition ${isActive && location.pathname === '/tentang/makna-logo'
                      ? 'bg-[#8b0000]/10 text-[#8b0000]'
                      : 'text-slate-700 hover:bg-slate-50 hover:text-[#8b0000]'
                    }`
                  }
            ...
            <div className="relative group">
              <button
                type="button"
                className={`flex items-center gap-1.5 py-1.5 text-[18px] font-semibold tracking-wide font-['Poppins'] transition-colors cursor-pointer ${location.pathname.startsWith('/informasi') ? 'text-[#8b0000] border-b-2 border-[#8b0000]' : 'text-black/85 hover:text-[#8b0000]'
                  }`}
              >
                <span>Berita</span>
                <FontAwesomeIcon icon={faChevronDown} className="text-[10px] text-black/50 transition-transform group-hover:rotate-180 duration-300" />
              ...
              <div className="absolute left-0 top-full mt-1 w-52 origin-top-left rounded-xl border border-slate-200/80 bg-white p-2 shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform scale-95 group-hover:scale-100 z-50">
                <NavLink
                  to="/informasi/berita"
                  className={({ isActive }) =>
                    `flex items-center gap-3 rounded-lg px-4 py-2.5 text-[16px] font-semibold transition ${isActive
                      ? 'bg-[#8b0000]/10 text-[#8b0000]'
                      : 'text-slate-700 hover:bg-slate-50 hover:text-[#8b0000]'
                    }`
                  }
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 items-start">
            ...
            <div className="flex flex-col space-y-4 col-span-1">
              ...
              <div className="flex items-center gap-3">
                {/* Instagram SVG */}
                <a href="https://www.instagram.com/ikm_itera/" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition">
                ...
                {/* YouTube SVG */}
                <a href="https://www.youtube.com/@ikmitera8340" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition">
                  <svg width="40" height="40" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="50" height="50" rx="12" fill="#1e1818" />
                ...
                {/* TikTok SVG */}
                <a href="https://www.tiktok.com/@ikmitera" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition">
                  <svg width="40" height="40" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="50" height="50" rx="12" fill="#1e1818" />
